...
.btn-cancelar:hover { background: var(--surface-2); }

/* Breadcrumb */
.breadcrumb-nav { display: flex; align-items: center; gap: 6px; margin-bottom: 16px; font-size: .78rem; color: var(--text-muted); }
...
<div class="form-body">
    ...
    @php
        ...
        $titulo  = isset($usuario) ? '✏️ Editar usuario' : '➕ Nuevo usuario';
    @endphp
    ...
    <form method="POST" action="{{ $accion }}">
        ...
        {{-- ── Datos básicos ────────────────────────────────────── --}}
        <div class="form-card">
            <div class="form-card-header">👤 {{ $titulo }}</div>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <p style="font-size:.78rem;color:var(--text-muted);margin-bottom:12px">
                    Selecciona qué bloques de módulos verá este usuario en su panel principal.
                    Los Super Administradores ven todos automáticamente.
                </p>
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <p style="font-size:.78rem;color:var(--text-muted);margin-bottom:12px">
                    Define qué puede hacer el usuario en cada carpeta del sistema documental.
...
function toggleBloqueStyle(checkbox) {
    var label = checkbox.closest('.bloque-check');
    label.classList.toggle('activo', checkbox.checked);
}
</script>
@endpush
