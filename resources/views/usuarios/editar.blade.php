        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="bloques-grid-form">
                    ...
                    @php
                        $dynChecked = old("bloque_dinamico.{$modulo->id}", isset($bloquesDinamicos) && in_array($modulo->id, $bloquesDinamicos));
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div style="margin-bottom:18px">
                    ...
                    @php
                        // Para módulos sin submodulos (dinámicos), permitir asignar acceso al módulo raíz directamente
                        $carpetasPermisionables = $modulo->submodulos->isEmpty()
                            ? collect([$modulo])   // módulo raíz como entidad permisionable
                            : $modulo->submodulos;
...
// ── Selector de nivel de acceso para módulos especiales ────────────────────
function toggleNivelPerm(carpetaId, nivel) {
    const hidden = document.getElementById(`nivel-${carpetaId}`);
    // Si ya estaba seleccionado, deseleccionar (→ ninguno)
